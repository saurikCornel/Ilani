                ...
                ZStack {
                        ZStack {
                            ...
                            ZStack {
                                ...
                                if showBlock1 {
                                    BlockView7(shape: [[true], [true]], plusPositions: [[0, 0]], position: $block1Position, cellSize: cellSize, cellImage: "greenCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if showBlock2 {
                                    BlockView7(shape: [[true, true]], plusPositions: [[0, 1]], position: $block2Position, cellSize: cellSize, cellImage: "redCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if showBlock3 {
                                    BlockView7(shape: [[true, true], [true, false]], plusPositions: [[1, 0]], position: $block3Position, cellSize: cellSize, cellImage: "blueCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if showBlock4 {
                                    BlockView7(shape: [[true, false], [true, true]], plusPositions: [[1, 1]], position: $block4Position, cellSize: cellSize, cellImage: "greenCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if showBlock5 {
                                    BlockView7(shape: [[true, true], [true, true]], plusPositions: [[0, 0]], position: $block5Position, cellSize: cellSize, cellImage: "redCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if hasWon {
                                    WinView7(elapsedTime: elapsedTime)
                                }
                            }
                        }
                        ...
                        Image(.timePlate)
                            ...
                            .overlay(
                                ZStack {
                                    ...
                                    Text(bestTime == Int.max ? "--:--" : formatTime(bestTime))
