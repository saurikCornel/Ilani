...
struct LevelGame5: View {
    ...
    @State private var block2Position: CGPoint = CGPoint(x: -150, y: 0)
    @State private var block3Position: CGPoint = CGPoint(x: -150, y: 0)
    @State private var block4Position: CGPoint = CGPoint(x: -150, y: 0)
    @State private var block5Position: CGPoint = CGPoint(x: -150, y: 0)
                ...
                ZStack {
                        ZStack {
                            ...
                            ZStack {
                                ...
                                if showBlock1 {
                                    BlockView5(shape: [[true, false], [true, true], [true, false]], plusPositions: [[0, 0]], position: $block1Position, cellSize: cellSize, cellImage: "greenCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if showBlock2 {
                                    BlockView5(shape: [[true, true, true]], plusPositions: [[0, 2]], position: $block2Position, cellSize: cellSize, cellImage: "redCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if showBlock3 {
                                    BlockView5(shape: [[true, true], [true, true]], plusPositions: [[1, 0]], position: $block3Position, cellSize: cellSize, cellImage: "blueCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if showBlock4 {
                                    BlockView5(shape: [[true, true, false], [false, true, true]], plusPositions: [[1, 1]], position: $block4Position, cellSize: cellSize, cellImage: "greenCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if showBlock5 {
                                    BlockView5(shape: [[false, true, false], [true, true, true]], plusPositions: [[1, 1]], position: $block5Position, cellSize: cellSize, cellImage: "redCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if hasWon {
                                    WinView5(elapsedTime: elapsedTime)
                                }
                            }
