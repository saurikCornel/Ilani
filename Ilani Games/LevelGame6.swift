...
struct LevelGame6: View {
    ...
    @State private var block1Position: CGPoint = CGPoint(x: -100, y: 10)
    @State private var block2Position: CGPoint = CGPoint(x: -150, y: 100)
    @State private var block3Position: CGPoint = CGPoint(x: -150, y: 100)
    @State private var block4Position: CGPoint = CGPoint(x: -150, y: 100)
    @State private var block5Position: CGPoint = CGPoint(x: -150, y: 100)
                ...
                ZStack {
                        ZStack {
                            ...
                            ZStack {
                                ...
                                if showBlock1 {
                                    BlockView6(shape: [[true, false], [true, true], [true, false]], plusPositions: [[0, 0]], position: $block1Position, cellSize: cellSize, cellImage: "greenCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if showBlock2 {
                                    BlockView6(shape: [[true, true, true]], plusPositions: [[0, 2]], position: $block2Position, cellSize: cellSize, cellImage: "redCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if showBlock3 {
                                    BlockView6(shape: [[true, true], [true, true]], plusPositions: [[1, 0]], position: $block3Position, cellSize: cellSize, cellImage: "blueCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                // Блок 4: Z-форма с greenCell (появляется при захвате третьего)
                                if showBlock4 {
                                    BlockView6(shape: [[true, true, false], [false, true, true]], plusPositions: [[1, 1]], position: $block4Position, cellSize: cellSize, cellImage: "greenCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                // Блок 5: T-форма с redCell (появляется при захвате четвертого)
                                if showBlock5 {
                                    BlockView6(shape: [[false, true, false], [true, true, true]], plusPositions: [[1, 1]], position: $block5Position, cellSize: cellSize, cellImage: "redCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if hasWon {
                                    WinView6(elapsedTime: elapsedTime)
                                }
                            }
