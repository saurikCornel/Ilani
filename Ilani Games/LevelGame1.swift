                ...
                ZStack {
                        ZStack {
                            ...
                            ZStack {
                                ...
                                if showBlock1 {
                                    BlockView(shape: [[true, false], [true, true]], plusPositions: [[1, 0]], position: $block1Position, cellSize: cellSize, cellImage: "greenCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if showBlock2 {
                                    BlockView(shape: [[true, true, true]], plusPositions: [[0, 1]], position: $block2Position, cellSize: cellSize, cellImage: "redCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if showBlock3 {
                                    BlockView(shape: [[true, true], [true, true]], plusPositions: [[0, 1]], position: $block3Position, cellSize: cellSize, cellImage: "blueCell")
                                        .gesture(
                                            !hasWon ? DragGesture()
                                                .onChanged { value in
                                ...
                                if hasWon {
                                    WinView1(elapsedTime: elapsedTime)
                                }
                            }
